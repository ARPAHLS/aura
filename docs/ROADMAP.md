...
| **Unreleased** | See [CHANGELOG `#unreleased`](../CHANGELOG.md#unreleased): escalation playbooks ([#47](https://github.com/ARPAHLS/aura/issues/47)), verified identity via spectrum ([#73](https://github.com/ARPAHLS/aura/issues/73)), `spectrum.services[]` + Limit preset ([#77](https://github.com/ARPAHLS/aura/issues/77)) |
